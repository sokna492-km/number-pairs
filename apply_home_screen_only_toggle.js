...
// 2. Build the updated script with Home Screen only visibility
const modernInjection = `  <!-- Kantumruy Pro Font & Minimalist Language Toggle -->
  ...
  <style id="kantumruy-custom-styles">
    ...
    * {
    ...
    /* Hidden when inside practice pages/screens */
...
console.log('Successfully updated index.html so toggle appears ONLY on home page!');
